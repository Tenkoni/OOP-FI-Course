...
void ReporteWEB::SetTitulo (std::string _titulo) override
{
	this->titulo = _titulo;
}

void ReporteWEB::SetEncabezado (std::string _encabezado) override
{
	this->encabezado = _encabezado;
}

void ReporteWEB::SetCuerpo (std::string _cuerpo) override
{
	this->cuerpo = _cuerpo;
}

std::string ReporteWEB::Generar() override
{
	this->pagina = "<HTML>";
	this->pagina +="	<HEAD>"<<std::endl;
	...
	this->pagina +="		<P>TOTAL: "+std::to_stringCalcular())+"</P>";
	this->pagina +="	</BODY>";
	this->pagina +="</HTML>";

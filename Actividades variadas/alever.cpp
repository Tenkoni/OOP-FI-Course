...
public:
	...
	LocalLinea(std::string _nombre, std::string _direccion, int _puntaje, std::vector inv);
	/**
...
LocalLinea::LocalLinea (std::string _nombre, std::string _direccion, int _puntaje, std::vector inv) :
						Local {_nombre, _direccion, _puntuaje}, inventario {inv}
{
	//nada
}

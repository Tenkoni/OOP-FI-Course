...
int main ()
{
	Paquete paquete("Anthony Brower", "Newport Road 89", "Carmacoup", "Lanark", "ML11 7NL","Candy White", "Maidstore Road 12", "Wentworth Castle", "Barnsley" ,"S75 8JA", 2.3, 15.0);
	...
	PaqueteNocturno paquetenocturno ("Alf", "Prof. Miguel Serrano 20", "Benito Juárez", "CDMX", "03100", "Eluviera Aniv", "Bustamante 20 Ejido del centro", "Tocumbo", "Michoacán", "81021", 3.1, 15.0, 7.0);

	std::cout<<"El costo de envio del paquete 1 es: "<<paquete.CalcularCosto()<<std::endl;
	std::cout<<"El costo de envio del paquete 2 es: "<<paquetedosdias.CalcularCosto()<<std::endl;
	std::cout<<"El costo de envio del paquete 3 es: "<<paquetenocturno.CalcularCosto()<<std::endl;
